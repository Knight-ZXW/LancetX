...
/**
 * Created by Knight-ZXW on 17/5/22.
 */
public class CheckFlow {
    ...
    public static class FlowNode {
        ...
        // TODO: This grain is too coarse.
        //  Now, we just judge the extend and implements flow, check if some classes lost.
        public boolean checkExactly(Node n) {
            if (n.checkPass[0]) {
                return true;
            }
            Map<String, Node> map = directChildrenOf(n);
            WeaverLog.d(map.size() + " " + children.size());
